...
<html>
    <head>
        ...
        <link rel="icon" type="image/png" href="../../resources/img/favicon32.ico" sizes="32x32">
    ...
    <body>
        <header>
            ...
            <img src="${pageContext.request.contextPath}/resources/img/Logo_MV.png" class="col-md">
